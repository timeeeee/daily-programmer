"""
Reddit Daily Programmer Challenge #285 [Hard] Math Proofs

Part 1
------

Determine if a mathematical expression is logically equivalent. Our first
program will only support 4 basic operators; +,-,*,/.
